...
import uebung09.ml.aufgabe04.BinarySearchTree.Entry;
...
public class AVLTreeJUnitTest {
  ...
  @Before
  public void setUp() {
    avlTree = new AVLTree<Integer, String>();
    //avlTree = new AVLTreeGVS<Integer, String>();
  }
  
  @After
  public void tearDown() {
    if (avlTree instanceof AVLTreeGVS) {
      ((AVLTreeGVS<Integer, String>)avlTree).gvsTree.disconnect();
    }
  }
  ...
  public void testMultipleSameKeys() {
    ...
    Collection<AVLTree<Integer, String>.AVLNode> nodes = new LinkedList<AVLTree<Integer, String>.AVLNode>();
...
private void verifyInorder() {
  ...
  private void runTest(int[] keys, String[] expected) {
    ...
    Collection<AVLTree<Integer, String>.AVLNode> nodes = new LinkedList<AVLTree<Integer, String>.AVLNode>();
    avlTree.inorder(nodes, avlTree.getRoot());
    assertSame(expected.length, nodes.size());
    verify(nodes, expected);
  }

  private void verify(Collection<AVLTree<Integer, String>.AVLNode> nodes, String[] expected) {
    int i = 0;
    for (AVLTree<Integer, String>.AVLNode node: nodes) {
